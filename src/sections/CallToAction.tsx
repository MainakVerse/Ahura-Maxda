      ...
      <div className="container">
        ...
        >
          ...
          <div className="relative">
            <h2 className="text-4xl md:text-5xl text-center font-medium tracking-tighter max-w-sm mx-auto">
              Creations for You, Crafted with care
            </h2>
            <p className="text-lg md:text-xl text-center text-white/70 tracking-tight px-5 mt-5 max-w-xs mx-auto">
              Create impactful content without the mess.
            </p>
            <div className="flex justify-center mt-8">
              <Link href="/services"><Button>Check Services</Button></Link>
            </div>
          </div>
        </motion.div>
      </div>
